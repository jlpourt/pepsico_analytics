...
Generate a concise, 45-second executive spoken audio briefing for senior leadership.
Data Context:
- Region: ${region}
...
Format: Return JSON with keys "title" and "script". No markdown formatting.`;
      ...
      systemPrompt = `You are the PepsiCo Executive Agronomy AI Briefing Anchor.
Generate a concise, 45-second executive spoken audio briefing detailing Frito-Lay chip potato variety performance.
Data Context:
...
Format: Return JSON with keys "title" and "script". No markdown formatting.`;
      ...
      systemPrompt = `You are the PepsiCo Executive Agronomy AI Briefing Anchor.
Generate a concise, 45-second executive spoken audio briefing for PepsiCo's 2026 Sustainability and Water Stewardship goals.
Data Context:
